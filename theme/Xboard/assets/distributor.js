(function () {
  ...
  async function handleAction(target) {
    ...
    if (action === 'logout') {
      ...
      const toggle = document.querySelector('[data-action="toggle-order-columns"]');
      if (toggle) { const label = t(state.orderFixedColumnsExpanded ? 'collapseOrderColumns' : 'expandOrderColumns'); toggle.textContent = label; toggle.setAttribute('aria-label', label); }
